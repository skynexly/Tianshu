...
try { await Gaiden.init(); } catch(e) { console.error('[Gaiden.init]', e); }
  ...
  // ===== 更新公告（登录成功后弹出，可拿到昵称）=====
  try {
    const APP_VERSION = 'v694.0';
const CHANGELOG = `【v694.0 更新内容】
· 新增：单人卡 AI 写卡助手（一键生成角色卡）
· 新增：角色卡详细设定/开场白/对话样例支持全屏编辑与 AI 局部生成
· 新增：聊天气泡时间戳可切换现实/游戏时间
· 优化：世界观 AI 生成全面增强——地区/势力/角色/事件/开场生成时可读取完整世界设定、历法、地区势力结构、世界书条目
· 优化：AI 生成角色新增速查简介（性别·年龄·发色瞳色·身份职业·性格）
· 修复：AI 生成开场时间未回填、对话背景图标题丢失等问题`;
