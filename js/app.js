...
○ 影视作品可绑定音乐 App 里的歌当主题曲，评论区会聊到它
📺 直播玩法
○ 支持高亮弹幕、打赏、连麦、购物车、PK；打赏进余额，购物车下单进物流订单
○ 高额打赏 / 榜前观众可能被主播主动私聊
○ 也能自己开播当主播
🌐 互联网生态互通
○ 论坛能搜到 / 日常刷到书架、观看历史里作品的讨论
○ 视频 App 有概率刷到书架已有书的改编作；阅读里搜影视名能搜到同人文；电台话题会带到论坛/阅读/视频的内容
💬 好友圈 & 群聊
○ 各 App 支持分享到好友圈；自己的动态可回复、追加评论
○ 主线可创建群聊 / 触发群消息（对话设置 → 玩法 里开启）
📒 新增「角色记事本」
○ 自动记录角色在天枢城各 App 里的网络行为，并注入聊天让角色"记得自己做过什么"`;
