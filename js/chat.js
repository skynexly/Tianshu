...
// v627：人机恋场景下也启用——只要面具+记忆库里有内容就发
{
  ...
  try {
    ...
    _constraintDepth3.push('【绝对禁止代写{{user}}】禁止以"你"为主语描写{{user}}的任何主动行为，包括但不限于：说话（"你说""你问""你低声道"）、肢体动作（"你伸手""你转身""你挂上停车挡""你手搭在方向盘上"）、表情（"你微微一笑""你皱眉"）、移动（"你走向""你坐下"）。也禁止替{{user}}写出任何台词——无论是否用引号包裹。唯一允许使用"你"的情况是描写不可抗的环境感知（如"你听到远处传来爆炸声""一阵冷风吹过你的脸"），且应尽量改为以环境或NPC为主语。违反此规则的回复是不合格的。');
  }
