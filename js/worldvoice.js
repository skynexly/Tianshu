...
8. 其中需包含1-2条来自有设定角色的帖子，发帖内容和语气必须符合该角色性格。username 直接填该角色在列表中"-"后面的名字，不要加任何额外文字
...
4. 评论时间必须依次晚于该帖子的发帖时间和已有的最新评论。请根据“当前游戏时间”智能安排回复节奏：
   ...
   - 严禁跳跃到不合逻辑的遥远未来。
5. 其中需包含1-2条来自有设定角色的评论，评论语气和内容必须符合该角色性格。username 直接填该角色在列表中的名字，不要加任何额外文字
